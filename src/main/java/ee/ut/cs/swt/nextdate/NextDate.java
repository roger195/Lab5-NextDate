...
//		return month == 1 || month == 3 || month == 5 || month==7 || month == 8 || month == 10;
	...
	// To enable leap year functionality, first uncomment the lines starting from 184-190,
	// and then perform the following two steps
	// step 1: uncomment lines 85-87 and 90,
	// step 2: uncomment lines 94-97 and 99
