...
public class GTv2 {
	...
	public void testCreatesNextDate1() throws Throwable {
	    NextDate nextDate0 = new NextDate(1803, 3, 3);
	    String string0 = nextDate0.run(3, 3, 1803);
	    assertEquals("3/4/1803", string0);
	}
	...
	public void testCreatesNextDate4() throws Throwable {
	    ...
	    String string0 = nextDate0.run(6, 31, 1981);
	    assertEquals("Invalid Input Date", string0);
	}
	...
	public void testCreatesNextDate15() throws Throwable {
	    ...
	    String string0 = nextDate0.run(8, 30, 1869);
	    assertEquals("8/31/1869", string0);
	}
	...
	public void testCreatesNextDate6() throws Throwable {
	    ...
	    String string0 = nextDate0.run(12, 12, 1868);
	    assertEquals("12/13/1868", string0);
	}
